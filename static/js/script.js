(function () {
  ...
  $(function () {
    ...
    writingMessage = new Message({
      text:
        "Hey, I am a ChatBot. I am designed to help you with identifying Spam and Phishing emails/sms. I support English and Spanish. Please feel free to ask me anything! Your UserID is " +
        userId,
      message_side: "left",
    });
    writingMessage.draw();
    ...
    function endSession() {
      ...
      fetch("/end-session", {
        ...
        .then((response) => {
          if (response.ok) {
            window.location.href = "/"; // Redirect to the login page or session end page
          }
        })
